...
public static class UIScale
{
    ...
    // ── 폰트 크기 ──────────────────────────────────────────────
    public const float FontSm = 24f;   // 보조 설명, 수치
    public const float FontMd = 30f;   // 일반 텍스트, 탭 레이블
    public const float FontLg = 44f;   // 섹션 제목
    public const float FontXl = 62f;   // 팝업 강조 제목
